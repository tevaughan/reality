...
which could potentially squeeze the sphere, must actually squeeze it flat.
...
Rather, each thing by nature has certain potentialities and some powers to
actualize potencies in other things.  A law of nature is what we propose in
order to summarize the interactions of things according to their
natures.\footnote{%
