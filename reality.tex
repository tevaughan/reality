...
in the West against her own heart.\footnote{%
   ...
   to the problem of qualia and to the mind-body problem, neither of which need
...
By explaining that
\begin{quote}
   in any change, what had existed only as a potentiality becomes an actuality,
\end{quote}
he showed how both permanence (in what remains actual) and change (in the
actualization of a potentiality) are real. Both the mind's comprehension of a
